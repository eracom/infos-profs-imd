...
Exceptions: si les élèves doivent récolter des informations hors de l'école. Par exemple: 
- Photographier une enseigne de magasin. 
- Amener un objet pour une réalisation. 
- Faire tester une interface à une personne de leur entourage.
- Réfléchir à une thématique et venir avec des idées pour un projet.
