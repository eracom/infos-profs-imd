...
- Veillez à toujours ***valider*** les notes après l'enregistrement. Si elles ne sont pas validées, cela empêche l'impression des bulletins.
- Utilisez la même date dans le fichier Excel.
