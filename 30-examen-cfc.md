...
Des exemples de données TPI des années précédentes (ainsi que des travaux de candidats) se trouvent dans Teams, sous **Examens > Archives TPI**. Les thèmes utilisés dans les écoles romandes: campagne pour le groupement des eaux de Romandie (2018), les jardins partagés (2019), Rec’Up ! (2021), antiguide touristique (2022), festivals de musique (2023).
...
Le calcul des notes est détaillé dans les «Dispositions d’exécution» (p. 4).
